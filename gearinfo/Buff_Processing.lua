...
function calculate_total_haste()
	Buffs_inform = {['delay'] = 0,['DEF'] = 0,['HP'] = 0,['MP'] = 0,['STR'] = 0,['DEX'] = 0,['VIT'] = 0,['AGI'] = 0,['INT'] = 0,['MND'] = 0,['CHR'] = 0,
								...
								-- ── OmniWatch patch ─────────────────────────
								-- Paeon → Regen, Ballad → Refresh, Tactician's
								-- Roll → Regain. Without these keys present in
								-- the reset, the aggregator at the end of this
								-- function silently drops their contributions
								-- (`if Buffs_inform[index] then` is nil-falsy
								-- on missing keys).
								['Regen'] = 0, ['Refresh'] = 0, ['Regain'] = 0,
								-- Courser's Roll → Snapshot. Without this key
								-- the aggregator drops it silently.
								['Snapshot'] = 0,
								-- Elemental resistances (Carols I/II). Bar
								-- spells write here too via OmniWatch's own
								-- buff watcher (separate from the bard chain).
								['Fire Resist']    = 0, ['Ice Resist']   = 0,
								['Wind Resist']    = 0, ['Earth Resist'] = 0,
								['Thunder Resist'] = 0, ['Water Resist'] = 0,
								['Light Resist']   = 0, ['Dark Resist']  = 0,
								}
